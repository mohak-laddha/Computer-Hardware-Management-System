//11 & 12  Implementing Generic & Collection Classes
...
class Shop1 extends Thread
{
	...
	try
	{
		...
		Shop1 thread = new Shop1();
		thread.start();	
		while(thread.isAlive())		//waiting for thread to finish
		{
			System.out.println("Wait Creating Table...");
		}
